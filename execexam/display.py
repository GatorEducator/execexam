...
def display_tldr(console: Console) -> None:
    ...
    console.print("[bold cyan]poetry run execexam <project> <tests> --maxfail[/bold cyan]")
    console.print("    Limit the number of test failures before stopping.")

    console.print("[bold cyan]poetry run execexam <project> <tests> --report <report_type>/<all>[/bold cyan]")
    console.print("    Generate the specified type(s) of reports after the exam. Use 'all' to generate all available report types.")

    console.print("[bold cyan]poetry run execexam <project> <tests> --advice-model <model> --advice-method <method>[/bold cyan]")
    console.print("    Use specified LLM model and method for providing advice on test failures.")

    console.print("[bold cyan]poetry run execexam <project> <tests> <--debug>/<--no-debug>[/bold cyan]")
    console.print("    Display or disable debugging information.")

    console.print("[bold cyan]poetry run execexam <project> <tests> <--fancy>/<--no-fancy>[/bold cyan]")

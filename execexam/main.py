...
# A list literal with the motivational quotes
...
def run(  # noqa: PLR0913, PLR0915
    ...
    if return_code != 0:
        ...
        console.print(f"[bold green]{motivation()}[/bold green]")

    else:

        console.print("YAY, YOU COMPLETED [bold green]ALL[bold green] THE CHECKS")

    # A conditional statement that either prints a motivational message or a completion message
